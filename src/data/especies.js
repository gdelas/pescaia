...
export const ESPECIES_DB = {
  mar:{
    ...
    embarcacion: ["Dorada","Besugo","Merluza","Pargo","Dentón","Cherne","Sama","Mero","Atún","Bonito","Pez espada","Pez limón","Marlín","Dorado","Wahoo","Listado"],
    kayak:       ["Lubina","Dorada","Corvina","Sargo","Bonito","Caballa","Pez limón","Pulpo"],
    curricán:    ["Atún","Bonito","Pez espada","Melva","Bacoreta","Pez limón","Palometa","Listado","Marlín","Dorado","Wahoo"],
  },
  laguna:{
...
export const ESPECIES_INFO = {
  ...
  "Marlín":{
    icono:"🦈",temporada:"Canarias: jun-nov · Atlántico norte: jul-oct",
    profundidad:"Aguas abiertas >500m de profundidad total. Superficie a 100m",
    condiciones:"T.agua >22°C, aguas azules oceánicas, corrientes cálidas, presencia de túnidos",
    cebos:{
      curricán:["Señuelo Black Bart 12\"","Teaser multifalda","Rapala grande azul-blanco","Ballyhoo natural","Calamar artificial 25cm"],
      embarcacion:["Pez vivo grande","Calamar natural entero","Jig 150-300g","Señuelo inchiku XL"],
    },
    tip:"El rey de la pesca deportiva. En España solo en Canarias y Atlántico norte con embarcación de altura. Pesca captura y suelta. Curricán a 7-9 nudos con señuelos de colores vivos. Seguir bandadas de aves y cambios de color del agua (verde-azul). Equipamiento pesado: caña 50-130lb. Temporada principal junio-noviembre en Canarias.",
  },
  "Dorado":{
    icono:"🐠",temporada:"Mediterráneo sur y Canarias: sep-nov · Llampuga en Baleares: sep-oct",
    profundidad:"0-50m superficie, sigue objetos flotantes y sargazo",
    condiciones:"T.agua >22°C, objetos flotantes en superficie, presencia de cardúmenes pequeños",
    cebos:{
      curricán:["Popper grande","Stickbait superficial","Rapala flotante","Pluma multicolor","Calamar artificial"],
      embarcacion:["Jig metal 40-80g","Vinilo shad 6\"","Calamar vivo","Pez pequeño vivo"],
      spinning:["Popper 15-20g","Stickbait","Jig metal plateado"],
    },
    tip:"También llamado Mahi-Mahi o Llampuga en Baleares. Pelágico muy vistoso de colores dorado-verde. Sigue objetos flotantes: palos, boyas, sargazo. Al ver el barco puede acercarse curioso. Curricán superficial muy efectivo. En Mediterráneo entra en septiembre-octubre. Combate espectacular y saltos. Muy bueno al comer.",
  },
  "Wahoo":{
    icono:"🐟",temporada:"Canarias: todo el año · Atlántico: verano-otoño",
    profundidad:"0-100m, aguas cálidas oceánicas",
    condiciones:"T.agua >24°C, aguas azules claras, corrientes cálidas, sin viento",
    cebos:{
      curricán:["Jig metal plateado 60-100g","Rapala a alta velocidad","Pluma barrilete","Señuelo rígido 15cm"],
      embarcacion:["Jig vertical 80-150g","Vinilo grande","Calamar artificial"],
    },
    tip:"También llamado Peto en Canarias. Uno de los peces más rápidos del océano (>70km/h). Curricán a 8-12 nudos, más rápido que para cualquier otra especie. Dientes afilados: usar cable o fluorocarbono muy grueso. Mordida explosiva. Principalmente en Canarias. Excelente en cocina.",
  },
  "Listado":{
    icono:"🐟",temporada:"Estrecho de Gibraltar y Mediterráneo: may-oct",
    profundidad:"0-80m, aguas superficiales templadas",
    condiciones:"T.agua >18°C, presencia de bocarte o sardina, corrientes activas",
    cebos:{
      curricán:["Pluma barrilete blanca","Jig metal 20-40g","Calamar artificial pequeño","Rapala pequeño"],
      embarcacion:["Jig metal 20-40g","Pluma","Vinilo 4\"","Cebo vivo (bocarte)"],
      spinning:["Jig metal plateado","Popper pequeño","Pluma"],
    },
    tip:"Túnido pequeño en grandes cardúmenes. Visible por el borboteo al perseguir carnada. Curricán a 5-6 nudos con pluma blanca. Muy abundante en Estrecho de Gibraltar en verano. Excelente indicador: donde hay listados, puede haber atún y pez espada cerca.",
  },
  "Pez espada":{
    icono:"🗡️",temporada:"Mediterráneo: may-oct · Canarias: may-oct · Atlántico: jun-sep",
    profundidad:"Noche: 0-50m superficie · Día: 100-1000m profundidad",
    condiciones:"T.agua >18°C, aguas abiertas profundas, viento suave, pesca nocturna muy efectiva",
    cebos:{
      curricán:["Señuelo inchiku tipo calamar 20cm","Calamar natural entero","Pota viva","Rapala X-Rap grande","Señuelo con cabeza silbato"],
      embarcacion:["Calamar entero en vertical","Jig slow pitch 150-250g","Luz estroboscópica con anzuelo","Pez pequeño muerto"],
    },
    tip:"Pelágico de aguas profundas. De noche sube a superficie a cazar: el mejor momento. Técnicas: curricán nocturno, jigging profundo 100-500m, pesca con cebo en profundidad. El señuelo inchiku que imita calamar es muy efectivo. En Mediterráneo: Tarragona y Barcelona son puntos de referencia. Talla mínima legal: 25kg. Caña 30-50lb.",
  },
  "Anguila":{
...
// Keep Anguila (was in original file, needs to be added back)
